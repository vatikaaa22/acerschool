...
?>
    ...
    <div class="w-full grid items-center justify-center gap-5 h-screen">
        <h1 class="text-white text-center font-bold text-3xl pt-5">&mdash;  Berita dan Acara &mdash; </h1>
        <div class="flex items-center justify-center gap-5 flex-wrap overflow-hidden">
            <div class="flex items-center gap-5 max-w-lg">
                <img src="https://img.daisyui.com/images/stock/photo-1635805737707-575885ab0820.jpg" class="rounded-lg shadow-2xl" />
                <div>
